...
ActiveRecord::Schema.define(version: 2019_08_31_134921) do
  ...
  create_table "categorias", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "nombre"
    t.text "descripcion"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "categorias_productos", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "categoria_id"
    t.integer "producto_id"
  end

  create_table "circulos", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "circulos_compras", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "compras", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "nombre"
    t.text "descripcion"
  ...
  create_table "delivery_statuses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "pedidos", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "items"
    t.integer "usuario_id"
    t.integer "circulo_id"
    t.datetime "created_at"
  ...
  create_table "pedidos_details", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "pedido_id"
  ...
  create_table "productos", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.float "precio"
    t.string "nombre"
  ...
  create_table "productos_warehouses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "producto_id"
    t.integer "warehouse_id"
  end
  ...
  create_table "transaction_details", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "usuario_roles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "usuario_id"
    t.integer "role_id"
    t.integer "warehouse_id"
    t.datetime "created_at"
  ...
  create_table "warehouses_compras", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "warehouse_id"
    t.integer "compra_id"
  end
